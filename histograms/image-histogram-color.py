# USAGE
# python color_histograms.py --image ../images/madison.jpg
...
# loop over the image BGR channels
for (chan, color) in zip(chans, colors):
	# create a histogram for the current channel and plot it
	# [chan] = BG or R to compute, [0] 0th channel...each only has 1, None =mask, 256=bins, 0 to 256 values
